...
# Python imports
# Local imports
from apps.accounts.forms import EmailAndUsernameChangeForm, PasswordChangingForm, ProfilePicChangeForm, TimezoneChangeForm
...
class SettingsView(LoginRequiredMixin, TemplateView, BaseMixin):
    ...
    def post(self, request, *args, **kwargs):
        if 'createListForm' in request.POST or 'createKeywordNotificationForm' in request.POST:
            ...
            profile_pic_change_form = ProfilePicChangeForm(request.POST, request.FILES, instance=request.user.profile)
            change_timezone_form = TimezoneChangeForm(request.POST, instance=request.user.profile)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['profile_pic_change_form'] = ProfilePicChangeForm()
        ...
        context['change_timezone_form'] = TimezoneChangeForm(timezone=self.request.user.profile.timezone)
        return context
