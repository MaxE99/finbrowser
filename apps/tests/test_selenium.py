...
class NotificationTest(LiveServerTestCase):
    ...
    def test_open_source_from_keyword_notifications(self):
        driver = login()
        driver.find_element(By.CSS_SELECTOR, '.userSpace .notificationBell').click()
        sleep(1)
    ...
    def test_standard_use_cases_for_keyword_notifications(self):
        driver = login()
        driver.find_element(By.CSS_SELECTOR, '.userSpace .notificationBell').click()
        sleep(1)
        driver.find_elements(By.CSS_SELECTOR, '.notificationContainer .notificationHeadersContainer div')[-1].click()
    ...
    def test_create_and_delete_keyword_notifications(self):
        driver = login()
        driver.find_element(By.CSS_SELECTOR, '.userSpace .notificationBell').click()
        sleep(1)
        driver.find_elements(By.CSS_SELECTOR, '.notificationContainer .notificationHeadersContainer div')[-1].click()     
        sleep(1)
        driver.find_element(By.CSS_SELECTOR, '.userSpace .notificationContainer .createKeywordNotificationForm input[name=keyword]').send_keys('Test123')
        driver.find_element(By.CSS_SELECTOR, '.userSpace .notificationContainer .createKeywordNotificationForm .formSubmitButton').click()
        sleep(1)   
        driver.find_element(By.CSS_SELECTOR, '.userSpace .fa-cog a').click()
        sleep(1) 
        ...
        assert "Test123" not in last_keyword_notification.get_attribute('innerText')
...
class ContentTest(LiveServerTestCase):
    ...
    def test_double_content_filtering(self):
        ...
        test_standard_use_cases("http://127.0.0.1:8000/content/365/Tech/No/Twitter/")
        test_standard_use_cases("http://127.0.0.1:8000/content/365/Tech/No/Twitter/", True)
...
class SearchResultTest(LiveServerTestCase):
    ...
    def test_standard_use_cases(self):
        test_standard_use_cases("http://127.0.0.1:8000/search_results/China")
    ...
    def test_paginations(self):
        test_pagination("http://127.0.0.1:8000/search_results/China", 0, '?filtered_articles=2')
        test_pagination("http://127.0.0.1:8000/search_results/China", 1, '?filtered_tweets=2')
...
class SettingsTest(LiveServerTestCase):
    ...
    def test_change_username_and_email(self):
        ...
        sleep(1)
        driver.find_element(By.CSS_SELECTOR, '#id_username').clear()
        driver.find_element(By.CSS_SELECTOR, '#id_username').send_keys("@#官话/官")
        driver.find_element(By.CSS_SELECTOR, '#id_email').clear()
        driver.find_element(By.CSS_SELECTOR, '#id_email').send_keys("me-99@livetest.de")
        driver.find_element(By.CSS_SELECTOR, '.editSection .saveButton').click()
        assert "@#官话/官" == driver.find_element(By.CSS_SELECTOR, "#id_username").get_attribute('value') and "me-99@livetest.de" == driver.find_element(By.CSS_SELECTOR, "#id_email").get_attribute('value')
        sleep(5)
        driver.find_element(By.CSS_SELECTOR, '#id_username').clear()
        driver.find_element(By.CSS_SELECTOR, '#id_username').send_keys("Ebirdmax99")
        driver.find_element(By.CSS_SELECTOR, '#id_email').clear()
...
class ListDetailTest(LiveServerTestCase):
    ...
    def test_change_list_name(self):
        ...
        driver.find_element(By.CSS_SELECTOR, ".nameChangeContainer #id_name").send_keys("test0207")
        driver.find_element(By.CSS_SELECTOR, ".notificationAndSubscribtionContainer .buttonContainer input").click()
        sleep(1)
        assert str(driver.find_element(By.CSS_SELECTOR, "h3").get_attribute('innerText')) == "Test0207-2-new"
        driver.find_element(By.CSS_SELECTOR, ".editButton").click()
        driver.find_element(By.CSS_SELECTOR, ".nameChangeContainer #id_name").clear()
        driver.find_element(By.CSS_SELECTOR, ".nameChangeContainer #id_name").send_keys("Test0207-2-new")
        driver.find_element(By.CSS_SELECTOR, ".notificationAndSubscribtionContainer .buttonContainer input").click()
...
class SourceRankingTest(LiveServerTestCase):
    ...
    def test_open_profile_by_clicking_profile_img(self):
        ...
        driver.find_element(By.CSS_SELECTOR, ".sourceRankingContainer .leftSide a").click()
    ...
    def test_open_sector(self):
        driver = login("http://127.0.0.1:8000/sources")
        current_url = driver.current_url
        driver.find_element(By.CSS_SELECTOR, ".infoWrapper .sectorInfoContainer a").click()
        WebDriverWait(driver, 10).until(UrlHasChanged(current_url)) 
        assert driver.current_url.startswith("http://127.0.0.1:8000/sector/")

    def test_open_website(self):
        driver = login("http://127.0.0.1:8000/sources")
        driver.find_element(By.CSS_SELECTOR, ".infoWrapper .websiteInfoContainer a").click()
        driver.switch_to.window(driver.window_handles[1])
        assert driver.current_url.startswith("http://127.0.0.1:8000") == False

    def test_clicking_tags(self):
        driver = login("http://127.0.0.1:8000/sources")
        second_source_ranking_container = driver.find_elements(By.CSS_SELECTOR, ".sourceRankingContainer")[1]
        tag = second_source_ranking_container.find_element(By.CSS_SELECTOR, ".thirdRow .tag")
        tag_name = tag.get_attribute("innerText")
        tag.click()
        assert tag_name == driver.find_element(By.CSS_SELECTOR, ".filterSidebar .selectedTagsContainer li").get_attribute("innerText")

    def test_subscribe_source(self):
        driver = login("http://127.0.0.1:8000/sources")
        second_source_ranking_container = driver.find_elements(By.CSS_SELECTOR, ".sourceRankingContainer")[1]
        subscribe_button = second_source_ranking_container.find_element(By.CSS_SELECTOR, '.fourthRow .subscribeButton')
        initial_subscribtion_status = subscribe_button.get_attribute("innerText")
        subscribe_button.click()
        driver = login("http://127.0.0.1:8000/sources")
        assert initial_subscribtion_status != subscribe_button.get_attribute("innerText")

    def test_add_to_list(self):
        driver = login("http://127.0.0.1:8000/sources")
        second_source_ranking_container = driver.find_elements(By.CSS_SELECTOR, ".sourceRankingContainer")[1]
        WebDriverWait(second_source_ranking_container, 5).until(expected_conditions.element_to_be_clickable((By.CSS_SELECTOR, ".fourthRow .sourceAddToListButton"))).click()
        second_source_ranking_container.find_element(By.CSS_SELECTOR, ".fourthRow .addToListForm .formHeaderContainer").click()

    def test_filtering_websites(self):
        driver = login("http://127.0.0.1:8000/sources")
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .dropdown').click()
        driver.find_elements(By.CSS_SELECTOR, '.filterSidebar .dropdown ul li input')[0].click()
        driver.find_elements(By.CSS_SELECTOR, '.filterSidebar .dropdown ul li input')[1].click()
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .applyFilterButton').click()
        assert driver.current_url == "http://127.0.0.1:8000/sources?website=SeekingAlpha&website=Spotify"

    def test_filtering_sectors(self):
        driver = login("http://127.0.0.1:8000/sources")
        sector_dropdown = driver.find_elements(By.CSS_SELECTOR, '.filterSidebar .dropdown')[1]
        ...
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .applyFilterButton').click()
        assert driver.current_url == "http://127.0.0.1:8000/sources?sector=Defense&sector=Energy"

    def test_filtering_tags(self):
        driver = login("http://127.0.0.1:8000/sources")
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .mainSearchContainer input').send_keys('Tag')
        WebDriverWait(driver, 2000).until(expected_conditions.element_to_be_clickable((By.CSS_SELECTOR, ".filterSidebar .mainSearchWrapper .selectionList li"))).click()
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .mainSearchContainer input').send_keys('N')
        WebDriverWait(driver, 2000).until(expected_conditions.element_to_be_clickable((By.CSS_SELECTOR, ".filterSidebar .mainSearchWrapper .selectionList li"))).click()
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .applyFilterButton').click()
        assert driver.current_url == "http://127.0.0.1:8000/sources?tag=TagNr0&tag=TagNr1"

    def test_filtering_other_criteria(self):
        driver = login("http://127.0.0.1:8000/sources")
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .applyFilterButton').click()
        content_type_container = driver.find_elements(By.CSS_SELECTOR, '.filterSidebar .selectContainer')[3]
        paywall_container = driver.find_elements(By.CSS_SELECTOR, '.filterSidebar .selectContainer')[4]
        top_sources_container = driver.find_elements(By.CSS_SELECTOR, '.filterSidebar .selectContainer')[5]
        content_type_container.find_element(By.CSS_SELECTOR, '.choiceContainer input').click()
        paywall_container.find_element(By.CSS_SELECTOR, '.choiceContainer input').click()
        top_sources_container.find_element(By.CSS_SELECTOR, "input").click()
        driver.find_element(By.CSS_SELECTOR, '.filterSidebar .applyFilterButton').click()
        assert driver.current_url == "http://127.0.0.1:8000/sources?content=Analysis&paywall=Yes&top_sources_only=on"
