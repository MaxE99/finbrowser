...
urlpatterns = [
    ...
    path('lists/<str:timeframe>/<str:content_type>/<str:minimum_rating>/<str:sources>/', ListSearchView.as_view(), name="lists-search"),
    path('sectors/', SectorView.as_view(), name="sectors"),
    path('articles/', ArticleView.as_view(), name="articles"),
    path('articles/<str:timeframe>/<str:sector>/<str:paywall>/<str:sources>/', ArticleSearchView.as_view(), name="articles-search"),
